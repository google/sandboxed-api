...
constexpr std::array kSyscallDataX8664 = {
    ...
    MakeEntry(180, "nfsservctl", kInt, kPtr, kPtr),     // Not implemented.
    ...
    MakeEntry(431, "fsconfig", kResource, kInt, kPtr, kPtr, kInt),
    ...
    MakeEntry(443, "quotactl_fd", kResource, kInt, kInt, kPtr),
