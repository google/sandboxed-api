...
SANDBOX_FUNCS(mylib_is_sandboxed, mylib_scalar_types, mylib_add,
              ...
              mylib_take_host_opaque_ptr, mylib_copy, mylib_copy_ptr,
              mylib_copy_raw, mylib_strlen, mylib_get_const_c_str,
              mylib_get_other_c_str, mylib_get_inoutparam_c_str,
              mylib_get_outparam_c_str, mylib_fill_outbuffer_returning_alias,
