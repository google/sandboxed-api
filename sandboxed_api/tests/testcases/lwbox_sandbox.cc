...
SANDBOX_FUNCS(mylib_is_sandboxed, mylib_scalar_types, mylib_add, mylib_copy,
              ...
              mylib_get_const_c_str, mylib_get_other_c_str,
              mylib_get_inoutparam_c_str, mylib_get_outparam_c_str,
              mylib_get_in_outparam_c_str, mylib_in_prim_struct_pointer,
              mylib_out_prim_struct_pointer, mylib_inout_prim_struct_pointer,
              mylib_in_prim_struct_array, mylib_out_prim_struct_array,
              mylib_inout_prim_struct_array, mylib_expected_syscall1,
