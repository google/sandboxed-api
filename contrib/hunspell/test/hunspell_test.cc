...
class HunspellTest : public ::testing::Test {
 protected:
  ...
  static constexpr char kAffixFileName[] = "utf8.aff";
  static constexpr char kDictionaryFileName[] = "utf8.dic";

  static constexpr char kGoodFileName[] = "utf8.good";
  static constexpr char kWrongFileName[] = "utf8.wrong";

  static constexpr char kSuggestion[] = "fo";
  static constexpr char kRandomWord[] = "random_word123";
...
TEST_F(HunspellTest, CheckAddToDict) {
  sapi::v::ConstCStr cbuf(kRandomWord);
...
TEST_F(HunspellTest, CheckSuggestion) {
  sapi::v::ConstCStr cbuf(kSuggestion);
